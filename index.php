<?php
	...
	class EncodeExplorer {
		...
		<head>
			...
			<style>
				/* Reset */
				* {margin: 0;padding: 0;color:#3c4043;}
				html, body, div, span, applet, object, iframe, h1, h2, h3, h4, h5, h6, p, blockquote, pre, a, abbr, acronym, address, big, cite, code, del, dfn, em, img, ins, kbd, q, s, samp, small, strike, strong, sub, sup, tt, var, b, u, i, center, dl, dt, dd, ol, ul, li, fieldset, form, label, legend, table, caption, tbody, tfoot, thead, tr, th, td, article, aside, canvas, details, embed, figure, figcaption, footer, header, hgroup, menu, nav, output, ruby, section, summary, time, mark, audio, video {margin: 0;padding: 0;border: 0;font-size: 100%;font: inherit;vertical-align: baseline;}
				html, body {font-family: Roboto,RobotoDraft,Helvetica,Arial,sans-serif;font-weight: normal; font-style: normal;-webkit-font-smoothing: antialiased;}
				a{text-decoration:none;}
				a:hover {color:#1967d2;background-color:#e8f0fe;}
				a:focus {color:#1967d2;background-color:#e8f0fe;}
				/* Styling */
				#direx {width:100%;height:100%;max-width:98%;margin:10px auto;}
				.dir_wrap {position:relative;}
				.dir_item {display:inline-block;}

				/*
					NOTE: Breadcrumb
				*/
				.dir_bread {display:flex;margin-bottom:20px;}
				.dir_bread .dir_bread_item {display:flex;justify-content: flex-start;align-items:center;}
				.dir_bread .dir_bread_item a {display:block;padding:7px;font-size:18px;line-height:1;border-radius:5px;}
				.dir_bread .dir_bread_item:not(:last-child) a {color:#babcbe;}
				.dir_bread .dir_bread_item:not(:last-child) a:hover {color:#1967d2;}
				.dir_bread .dir_bread_item:last-child a {pointer-events:none;}
				.dir_bread .dir_bread_item + .dir_bread_item:before {content:"";width:18px;height:18px;background-color:#808080;-webkit-mask:url('data:image/svg+xml;base64,') no-repeat center center;
				mask:url('data:image/svg+xml;base64,') no-repeat center center;
				-webkit-mask-size:cover;mask-size:cover;display:inline-block;}

				/*
					NOTE: Directory items wrap
				*/
				.dir_wrap {display:flex;flex-wrap:wrap;}
				.dir_wrap .dir {width:200px;margin-bottom:30px;}
				.dir_wrap .dir a {display:block;margin-right:10px;padding:20px;border-radius:5px;}
				.dir_wrap .dir .dir_item {position:relative;border:1px solid #dddddd;overflow-wrap:break-word;}
				.dir_wrap .dir .dir_item:hover {
					background: rgba(255,255,255,1);
					background: -moz-linear-gradient(top, rgba(255,255,255,1) 0%, rgba(235,243,253,1) 100%);
					background: -webkit-gradient(left top, left bottom, color-stop(0%, rgba(255,255,255,1)), color-stop(100%, rgba(235,243,253,1)));
					background: -webkit-linear-gradient(top, rgba(255,255,255,1) 0%, rgba(235,243,253,1) 100%);
					background: -o-linear-gradient(top, rgba(255,255,255,1) 0%, rgba(235,243,253,1) 100%);
					background: -ms-linear-gradient(top, rgba(255,255,255,1) 0%, rgba(235,243,253,1) 100%);
					background: linear-gradient(to bottom, rgba(255,255,255,1) 0%, rgba(235,243,253,1) 100%);
					filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#ffffff', endColorstr='#ebf3fd', GradientType=0 );
					border:1px solid #b8d6fb;
				}
				.dir_wrap .dir .dir_item-info {margin-top:5px;font-size:12px;}
			</style>
		</head>
		<body>
			...
			<div id="direx">
				...
				<div class="dir_bread">
					<div v-for="(item, index) in breadcrumb" :key="index" class="dir_bread_item">
						<a :href="item.href" v-html="item.text"></a>
					</div>
				</div>

				<div class="dir_wrap">
					<div v-for="item in items" class="dir">
						<a :href="item.dir.link" class="dir_item" :data-type="item.dir.ico">
							{{item.dir.name}}<br/>

							<div class="dir_item-info">
								{{item.modified}}<br/>
			...
			new Vue({
				...
				data: {
					breadcrumb: [
						{text:'<?php print $this->getString("root"); ?>', href:'?dir='},
						<?php
							for($i = 0; $i < count($this->location->path); $i++)
							{
								print "{text:'".$this->location->getPathLink($i, true)."', href:'".$this->makeLink(false, false, null, null, null, $this->location->getDir(false, true, false, count($this->location->path) - $i - 1))."'},";
							}
						?>
					],
					items: [ 
						{dir:{name:'..',link:'<?php print $this->makeLink(false, false, null, null, null, $this->location->getDir(false, true, false, 1)); ?>', ico:'parentfolder',}, filesize:'', modified:'', type:'Parent folder'},
						<?php
							$row = 1;
							if($this->dirs)
							{
								...
								{
									print "{dir:{name:'".$dir->getNameHtml()."', link:'".$this->makeLink(false, false, null, null, null, $this->location->getDir(false, true, false, 0).$dir->getNameEncoded())."', ico:'directory',}, filesize:'', modified:'".$this->formatModTime($dir->getModTime())."', type:'File Folder'},";
									$row =! $row;
								}
							}
							if($this->files)
							{
								...
								{
									print "{dir:{name:'".$file->getNameHtml()."', link:'".$this->location->getDir(false, true, false, 0).$file->getNameEncoded()."', ico:'".$file->getType()."'}, filesize:'".$this->formatSize($file->getSize())."', modified:'".$this->formatModTime($file->getModTime())."', type:'".$file->getType()."'},";
									$row =! $row;
								}
							}
						?>
